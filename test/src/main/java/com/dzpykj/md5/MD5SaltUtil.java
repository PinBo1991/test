...
public class MD5SaltUtil {
	...
	public static void main(String[] args) {
		try {
			System.out.println(getEncodedPw("2", ""));// 799047cd06cc08e137a21408db180dd2
//			System.out.println(getEncodedPw("2", "1").length());// 32
//			System.out.println(isPassword("c0c7d5bbbe88960a1c04339707595373", "1", "11111111"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
