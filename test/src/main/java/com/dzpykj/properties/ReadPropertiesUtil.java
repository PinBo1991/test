...
public class ReadPropertiesUtil {
	...
	private volatile static ReadPropertiesUtil instance;

	private ReadPropertiesUtil() {
		// TODO there,you can do something
	}
	...
	public static ReadPropertiesUtil getInstance() {
		if (instance == null) {
			synchronized (ReadPropertiesUtil.class) {
				if (instance == null) {
	 ...
	 * @throws Exception
	 */
	private Properties getResource(InputStream inputStream) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String getPropValue(final String propertiesName, final String key, final String... path)
			throws Exception {
	...
	public Map<String, String> readProperties(String filePath) throws IOException {
		...
		if (StringUtils.isBlank(filePath)) {
			// filePath =
			// Thread.currentThread().getContextClassLoader().getResourceAsStream(propertiesFileName+".properties");
		}
		InputStream in = new BufferedInputStream(new FileInputStream(filePath));
		props.load(in);
	 ...
	 * @throws IOException
	 */
	public void writeProperties(String filePath, String parameterName, String parameterValue) throws IOException {
